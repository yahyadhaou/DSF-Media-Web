  ...
  return (
    <div className="py-20 lg:py-28">
      <Container className="flex flex-col gap-4">
        ...
        <p className="max-w-xl text-base leading-relaxed text-white/60">{t("subtitle")}</p>
      </Container>
      ...
      <Container className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-[1.3fr_1fr]">
        ...
        <div className="flex flex-col gap-5">
          <div className="rounded-2xl border border-magenta/30 bg-gradient-to-br from-magenta/15 to-transparent p-7">
            ...
            <p className="text-sm text-white/70">{t("emergency.description")}</p>
          </div>

          <div className="flex flex-col gap-4 rounded-2xl border border-white/8 bg-ink-soft p-7">
          ...
          <div className="flex h-48 flex-col items-center justify-center gap-2 rounded-2xl border border-white/8 bg-ink-soft text-center">
            <MapPin size={26} className="text-teal" />
            <span className="max-w-[220px] text-xs text-white/40">{t("mapPlaceholder")}</span>
          </div>
        </div>
      </Container>
    </div>
